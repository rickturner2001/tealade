...
const Feature = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-x-4 gap-y-4   bg-[#17212D] py-4 px-8 text-sm font-medium text-white lg:flex-row lg:items-center lg:justify-start">
      <div>{children}</div>
