  ...
  return (
    <section className="mx-auto  w-full max-w-7xl px-6 text-center lg:px-0 lg:text-left">
      ...
      <p className="max-w-4xl py-4   text-gray-700">
        Discover our latest arrivals and stay ahead of the trend. Shop the
        newest and most exciting products added to our store. Find your new
        favorite fashion and home decor items now!
      </p>
      <button className="bg-black px-5 py-2.5 font-medium text-white">
        Show all
      </button>
      <div className="grid grid-cols-1 gap-y-10 gap-x-6 py-16 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
