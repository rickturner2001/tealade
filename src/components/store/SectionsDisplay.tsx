          ...
          >
            <div className="absolute top-0 right-0 z-30 flex h-full w-full items-center  bg-gradient-to-r from-black/80 p-12">
              <div className="w-full max-w-md">
                <span className="block text-4xl font-bold uppercase text-primary-500">
                  {section.label}
                </span>
                <span className="block py-2 text-lg font-medium text-white">
                  {section.description}
                </span>
                <button className="focus:ouline-none mt-4  bg-primary-500 py-2.5 px-5 text-neutral-900 focus:ring-4 focus:ring-primary-300">
                  View products
                </button>
              </div>
            </div>
